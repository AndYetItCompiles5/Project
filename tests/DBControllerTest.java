...
//	public void testEditUniversity() {
//		ArrayList<String> emphasis = new ArrayList<String>();
//		assertTrue(dbcontroller.editUniversity("_TESTSCHOOL", "MMIN", "URBAN", "PRIVATE", 100000, 50, 500, 500, 100000,
//				90, 10000, 98, 50, 1, 1, 1, emphasis));
//	}
//
	@Test(expected = IllegalArgumentException.class)
	...
	// public void testFindRecommendations() {
	//
	// ArrayList<String> listRecs =
	// dbcontroller.findRecommendations("_TESTSCHOOL");
	//
	// assertTrue("The first reccomended school for _TESTSCHOOL is
	// '_TESTSCHOOL1'", listRecs.get(0).equals("_TESTSCHOOL1"));
	// assertTrue("The second reccomended school for _TESTSCHOOL is
	// '_TESTSCHOOL2'", listRecs.get(1).equals("_TESTSCHOOL2"));
	// assertTrue("The third reccomended school for _TESTSCHOOL is
	// '_TESTSCHOOL3'", listRecs.get(2).equals("_TESTSCHOOL3"));
	// assertTrue("The fourth reccomended school for _TESTSCHOOL is
	// '_TESTSCHOOL4'", listRecs.get(3).equals("_TESTSCHOOL4"));
	// assertTrue("The fifth reccomended school for _TESTSCHOOL is
	// '_TESTSCHOOL5'", listRecs.get(4).equals("_TESTSCHOOL5"));
	//
	// }
